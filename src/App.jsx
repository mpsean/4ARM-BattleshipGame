          ...
          <div class="flex py-16 px-4 mx-auto max-w-screen-xl xl:py-8 lg:px-20 gap-4 items-center flex-col lg:flex-row">
              <div class="max-w-screen-md">
                ...
                <img 
                    ...
                    class="pt-24"
                />
                <div class="flex gap-10 pt-20">
                  <a href="./simple/index.html">
                  <button class="flex justify-center items-center gap-2 px-7 py-4 border-4 font-montserrat font-bold text-xl leading-none bg-coral-red text-white rounded-full bg-sky-700">
                    Simple Mode
                  </button>
                  </a>
