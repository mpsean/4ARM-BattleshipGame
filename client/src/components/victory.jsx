...
const Victory = () => {
  ...
  useEffect(() => {
    ...
    axios.get(`http://${import.meta.env.VITE_SERVER_IP}:3001/result/${userId}/getScore`)
      .then(response => {
    ...
    axios.get(`http://${import.meta.env.VITE_SERVER_IP}:3001/result/${opponentId}/getScore`)
      .then(response => {
  ...
  const handleDisconnect = () => {
    axios
      .put(`http://${import.meta.env.VITE_SERVER_IP}:3001/result/${userId}/resetScore`)
      .then((result) => {
      })
