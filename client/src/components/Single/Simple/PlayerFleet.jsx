...
export const PlayerFleet = ({
  ...
  let playButton = (
    <div className="bg-cyan-700 m-3 p-3 rounded-3xl" id="play-ready">
      ...
      <button className="gap-2 px-6 py-3 font-montserrat font-bold text-lg leading-none ring-4 ring-white text-white rounded-full bg-sky-700 dark:bg-sky-950 hover:bg-green-800" onClick={startTurn}>
        Confirm
      </button>
    </div>
  );
